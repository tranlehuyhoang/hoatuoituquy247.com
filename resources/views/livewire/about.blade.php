<div>
    <div>
        ...
        @endphp
        <head>
            <title>Giới thiệu | {{ $settings->web_name}} </title>
        ...
        <body class="bg-body">
                    ...
                    <div class="row row-noGutter">
                        <div class="col-xl-6 col-xs-12">
                            ...
                            <div class="info clearfix">
                                ...
                                <div class="actions"><button class="btn  btn-primary  margin-top-5 btn-continue">Tiếp tục
            ...
            <script src="/bizweb.dktcdn.net/100/436/596/themes/834446/assets/main.js?1721662888170" type="text/javascript">
            </script>
