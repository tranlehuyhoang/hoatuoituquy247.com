<div>
    <div>
        ...
        <head>
            <title>Tin tức | {{ $settings->web_name}} </title>
            ...
            <link href="/bizweb.dktcdn.net/100/436/596/themes/834446/assets/evo-watch.scss.css?1721662888170"
                rel="stylesheet" type="text/css" media="all" />
            <link rel="preload" as="style" type="text/css"
                href="/bizweb.dktcdn.net/100/436/596/themes/834446/assets/evo-blogs.scss.css?1721662888170" />
            <link href="/bizweb.dktcdn.net/100/436/596/themes/834446/assets/evo-blogs.scss.css?1721662888170"
                rel="stylesheet" type="text/css" media="all" />
                        ...
                        <div class="col-md-10 col-md-offset-1">
                            <div class="evo-blog-header-content">
                                ...
                                <div class="evo-blog-des">
                                    <p>Nơi chúng tôi chia sẻ những bài viết thú vị dựa trên những kinh nghiệm sau nhiều
                                        năm sử dụng và làm việc...</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section class="evo-list-blog-page">
                    ...
                    <section class="evo-list-blogs row">
                        ...
                        <article class="col-md-4 col-sm-4 col-xs-12 blog-item">
                            <a href="/blog/{{   $post->slug }}" title="{{ $post->title }}" class="clearfix">
                                <div class="evo-article-image lazyload">
                                    <img src="{{Storage::url($post->banner )}} "
                                        data-lazyload="{{ Storage::url($post->banner ) }}" alt="{{ $post->title }}"
                                        class="img-responsive center-block" />
                                </div>
                                <h3 class="line-clamp">{{ $post->title }}</h3>
                                            ...
                                            <nav class="text-center">
                                                <ul class="pagination clearfix">
                                                    ...
                                                    @for ($i = 1; $i <= $posts->lastPage(); $i++)
                                                        <li
                                                            class="page-item {{ $i == $posts->currentPage() ? 'active' : '' }}">
