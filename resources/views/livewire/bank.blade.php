                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                <div class="qr-code">
                                                    ...
                                                    <img src="https://api.vietqr.io/MB/104567890/{{number_format($order->grand_total + $order->shipping_amount, 0, ',', '')}}/{{ $order->order_code }}/vietqr_net_2.jpg?accountName=TRAN LE HUY HOANG"
                                                        width="100%" />
