<div>
    <div>
        ...
        <head>
            <title>Liên hệ | {{ $settings->web_name}} </title>
            ...
            <link rel="preload" as="style" type="text/css"
                href="/bizweb.dktcdn.net/100/436/596/themes/834446/assets/evo-contacts.scss.css?1721662888170" />
            <link href="/bizweb.dktcdn.net/100/436/596/themes/834446/assets/evo-contacts.scss.css?1721662888170"
                rel="stylesheet" type="text/css" media="all" />
                    ...
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <div class="page-login">
                                ...
                                <span class="text-contact block text-center">Bạn hãy điền nội dung tin nhắn vào form
                                    dưới
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-xs-12">
                                                <fieldset class="form-group">
                                                    ...
                                                    <input placeholder="Nhập họ và tên" type="text" wire:model="name"
                                            ...
                                            <div class="col-sm-6 col-xs-12">
                                                <fieldset class="form-group">
                                                    ...
                                                    <input placeholder="Nhập địa chỉ Email" type="email"
                                                        wire:model="email" class="form-control form-control-lg"
                                                        required />
                                                </fieldset>
                                            </div>
                                            <div class="col-sm-12 col-xs-12">
                                                <fieldset class="form-group">
                                                    ...
                                                    <input placeholder="Nhập số điện thoại" type="tel"
                                                        wire:model="phone" class="form-control form-control-lg"
                                                        required />
                                                </fieldset>
                                            </div>
                                            <div class="col-sm-12 col-xs-12">
                                                <fieldset class="form-group">
                                                    ...
                                                    <textarea placeholder="Nội dung liên hệ" wire:model="body"
                                                        class="form-control form-control-lg" rows="5"
                                                        required></textarea>
                                                </fieldset>
                                                <div class="pull-xs-left" style="margin-top:20px;">
                                                    <button type="submit"
                                                        class="btn btn-blues btn-style btn-style-active">Gửi tin
                                                        nhắn</button>
                                                </div>
                                            </div>
                                        </div>
