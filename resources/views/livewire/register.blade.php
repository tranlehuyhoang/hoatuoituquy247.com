<div>
    <div>
        ...
        @endphp
        <head>
            <title>Đăng ký tài khoản | {{ $settings->web_name}}</title>
                        ...
                        <div class="page-login account-box-shadow">
                            <div id="login">
                                ...
                                <div class="social-login text-center margin-bottom-10">
                                    ...
                                    href="{{ route('google.register', ['id' => 1]) }}"><img width="129px" height="37px"
                                            alt="google-login-button"
                                            src="/bizweb.dktcdn.net/assets/admin/images/login/gp-btn.svg"></a>
                                </div>
                                <form id="customer_register" accept-charset="UTF-8" wire:submit.prevent="register">
                                            ...
                                            <div class="col-md-12">
                                                <fieldset class="form-group">
                                                    ...
                                                    <input placeholder="Nhập Họ và tên" type="text"
                                                        class="form-control form-control-lg" wire:model="name" required
