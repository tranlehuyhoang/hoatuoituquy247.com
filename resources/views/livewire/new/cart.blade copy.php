<div>
    <div>
        ...
        <head>
            <title>Giỏ hàng - Hoa Tươi Tứ Quý</title>
            <link rel='prefetch'
            ...
            <link rel='stylesheet' id='flatsome-main-css'
                href='/assets/wp-content/themes/flatsome/assets/css/flatsome.css' type='text/css' media='all' />
            ...
            <link rel='stylesheet' id='flatsome-shop-css'
                ...
                media='all' />
            <link rel='stylesheet' id='flatsome-style-css' href='/assets/wp-content/themes/flower-delivery/style.css'
                type='text/css' media='all' />
            ...
            <script type="text/javascript" src="/assets/wp-includes/js/jquery/jquery-migrate.min.js" id="jquery-migrate-js">
            </script>
            ...
            <script type="text/javascript"
                src="/assets/wp-content/plugins/woocommerce/assets/js/jquery-blockui/jquery.blockUI.min.js" id="jquery-blockui-js"
            ...
            <script type="text/javascript" src="/assets/wp-content/plugins/woocommerce/assets/js/frontend/woocommerce.min.js"
            ...
            <script type="text/javascript" src="/assets/wp-content/plugins/woocommerce/assets/js/frontend/country-select.min.js"
            ...
            <script type="text/javascript" src="/assets/wp-content/plugins/woocommerce/assets/js/frontend/address-i18n.min.js"
            ...
            <script type="text/javascript" src="/assets/wp-content/plugins/woocommerce/assets/js/selectWoo/selectWoo.full.min.js"
            ...
            <script type="text/javascript" src="/assets/wp-includes/js/zxcvbn-async.min.js" id="zxcvbn-async-js"></script>
            ...
            <script type="text/javascript" src="/assets/wp-admin/js/password-strength-meter.min.js" id="password-strength-meter-js">
            </script>
            ...
            <link rel="alternate" title="JSON" type="application/json"
                href="https://tramhoa.com/wp-json/wp/v2/pages/7" />
            <link rel="EditURI" type="application/rsd+xml" title="RSD"
                href="https://tramhoa.com/xmlrpc.php?rsd" />
        ...
        <body
            ...
            <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TL79S2M" height="0"
                                        ...
                                        <div class="woocommerce row row-large row-divided">
                                            <div class="col large-7 pb-0 ">
                                                ...
                                                <form class="woocommerce-cart-form"
                                                    action="https://tramhoa.com/gio-hang/" method="post">
                                                    <div class="cart-wrapper sm-touch-scroll">
                                                        ...
                                                        <table
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    <th class="product-name" colspan="3">Sản phẩm
                                                                    </th>
                                                                    ...
                                                                    <tr
                                                                        ...
                                                                        <td class="product-name"
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <span
                                                                                    class="mobile-product-price__qty">1
                                                                                    x </span>
                                                                                <span
                                                                        ...
                                                                        <td class="product-quantity"
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <label class="screen-reader-text"
                                                                                    for="quantity_6744563207355">{{ $item['name'] }}
                                                                                    số lượng</label>
                                                                                <input id="quantity_6744563207355"
                                                ...
                                                <div class="cart-sidebar col-inner ">
                                                    <div class="cart_totals calculated_shipping">
                                                        ...
                                                        <table cellspacing="0">
                                                            <thead>
                                                                <tr>
                                                                    <th class="product-name" colspan="2">Cộng giỏ
                                                                        hàng</th>
                                                                </tr>
                                                            </thead>
                                                        </table>
                                    ...
                                    <form method="post"
                                        ...
                                        <div class="woocommerce-privacy-policy-text">
                                            <p>Thông tin cá nhân của bạn sẽ được sử dụng để tăng trải nghiệm sử dụng
                                                website,
                                                quản lý truy cập vào tài khoản của bạn, và cho các mục đích cụ thể khác
                                                được mô
            ...
            <script type="text/javascript" src="/assets/wp-includes/js/jquery/ui/core.min.js" id="jquery-ui-core-js"></script>
            <script type="text/javascript" src="/assets/wp-includes/js/jquery/ui/mouse.min.js" id="jquery-ui-mouse-js"></script>
            <script type="text/javascript" src="/assets/wp-includes/js/jquery/ui/slider.min.js" id="jquery-ui-slider-js"></script>
            <script type="text/javascript"
            ...
            <script type="text/javascript" src="/assets/wp-content/plugins/contact-form-7/includes/swv/js/index.js" id="swv-js">
            </script>
            ...
            <script type="text/javascript" src="/assets/wp-content/plugins/woocommerce/assets/js/select2/select2.full.min.js"
                id="select2-js" data-wp-strategy="defer"></script>
            ...
            <script type="text/javascript" src="/assets/wp-content/plugins/devvn-woo-address-selectbox/assets/js/devvn_tinhthanh.js"
            ...
            <script type="text/javascript" src="/assets/wp-content/plugins/woocommerce/assets/js/sourcebuster/sourcebuster.min.js"
            ...
            <script type="text/javascript" src="/assets/wp-content/plugins/woocommerce/assets/js/frontend/order-attribution.min.js"
                id="wc-order-attribution-js"></script>
            <script type="text/javascript" src="/assets/wp-includes/js/hoverIntent.min.js" id="hoverIntent-js"></script>
            ...
            <script type="text/javascript" src="/assets/wp-content/themes/flatsome/assets/js/flatsome.js" id="flatsome-js-js">
            </script>
