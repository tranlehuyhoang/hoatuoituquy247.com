<div>
    <head>
        ...
        <title>Chính sách bảo mật - Trạm Hoa</title>
        <meta name="description"
            content="Trình bày chính sách bảo mật thông tin của Trạm Hoa. Mô tả cách Trạm Hoa thu thập dữ liệu cá nhân của khách hàng và sử dụng như thế nào." />
        <meta name="robots" content="follow, index" />
        <link rel="canonical" href="https://tramhoa.com/chinh-sach-bao-mat/" />
        <meta property="og:locale" content="vi_VN" />
        <meta property="og:type" content="article" />
        <meta property="og:title" content="Chính sách bảo mật - Trạm Hoa" />
        <meta property="og:description"
            content="Trình bày chính sách bảo mật thông tin của Trạm Hoa. Mô tả cách Trạm Hoa thu thập dữ liệu cá nhân của khách hàng và sử dụng như thế nào." />
        <meta property="og:url" content="https://tramhoa.com/chinh-sach-bao-mat/" />
        <meta property="og:site_name" content="Trạm Hoa" />
        <meta property="article:publisher" content="https://www.facebook.com/tramhoavn/" />
        <meta property="og:updated_time" content="2024-10-29T21:38:54+07:00" />
        ...
        <meta property="article:published_time" content="2019-08-22T03:55:37+07:00" />
        <meta property="article:modified_time" content="2024-10-29T21:38:54+07:00" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Chính sách bảo mật - Trạm Hoa" />
        ...
        <link rel="alternate" type="application/rss+xml" title="Trạm Hoa &raquo; Chính sách bảo mật Dòng bình luận"
            href="https://tramhoa.com/chinh-sach-bao-mat/feed/" />
        ...
        <link rel="alternate" title="JSON" type="application/json" href="https://tramhoa.com/wp-json/wp/v2/pages/3" />
        <link rel="EditURI" type="application/rsd+xml" title="RSD" href="https://tramhoa.com/xmlrpc.php?rsd" />
        <meta name="generator" content="WordPress 6.7.1" />
        <link rel='shortlink' href='https://tramhoa.com/?p=3' />
        <link rel="alternate" title="oNhúng (JSON)" type="application/json+oembed"
            href="https://tramhoa.com/wp-json/oembed/1.0/embed?url=https%3A%2F%2Ftramhoa.com%2Fchinh-sach-bao-mat%2F" />
        <link rel="alternate" title="oNhúng (XML)" type="text/xml+oembed"
            href="https://tramhoa.com/wp-json/oembed/1.0/embed?url=https%3A%2F%2Ftramhoa.com%2Fchinh-sach-bao-mat%2F&#038;format=xml" />
    ...
    <body
        class="privacy-policy page-template-default page page-id-3 theme-flatsome woocommerce-no-js full-width header-shadow lightbox nav-dropdown-has-arrow nav-dropdown-has-shadow mobile-submenu-slide mobile-submenu-slide-levels-1">
                                ...
                                <ul
                                    ...
                                    <li class="header-block">
                                        <div class="header-block-block-1">
                                            <div class="img has-hover x md-x lg-x y md-y lg-y" id="image_1557580560">
                ...
                <div id="content" class="content-area page-wrapper" role="main">
                    <div class="row row-main">
                        <div class="large-12 col">
                            <div class="col-inner">
                                <h1 class="wp-block-heading has-text-align-center">Chính sách bảo mật</h1>
                                <h2 class="wp-block-heading">Mục đích và phạm vi thu thập thông tin</h2>
                                <p>Để có thể lên đơn hàng, quý khách hàng cung cấp thông tin cá nhân (Họ và Tên, số điện
                                    thoại, email, địa chỉ, …). Tất cả các thông tin đảm bảo chính xác và hợp pháp. Chúng tôi
                                    sẽ không chịu trách nhiệm pháp lí liên quan đến tất cả những thông tin khách hàng cung
                                    cấp.</p>
                                <h2 class="wp-block-heading">Phạm vi sử dụng thông tin</h2>
                                <p>Thông tin khách hàng chỉ được dùng để hỗ trợ việc lên đơn hàng cụ thể là chúng tôi dùng
                                    thông tin để liên hệ trực tiếp với khách hàng như tin nhắn sms, đơn đặt hàng, gửi thông
                                    tin thay đổi, …</p>
                                <h2 class="wp-block-heading">Thời gian lưu trữ thông tin</h2>
                                <p>Toàn bộ thông tin cá nhân của khách hàng sẽ được lưu trữ trên hệ thống nội bộ của chúng
                                ...
                                <p>Tất cả thông tin khách hàng cung cấp đều được Trạm Hoa bảo mật tuyệt đối và chỉ dùng cho
                                    việc thực hiện đơn hàng cũng như chăm sóc khách hàng.</p>
                                <p>Chúng tôi cam kết tuân thủ tất cả các quy định bảo mật thông tin cá nhân của khách hàng,
                                    tuyệt đối sẽ không để lộ thông tin cho bên thứ ba cũng như dùng cho những mục đích khác.
                                    Cam kết bảo mật các thông tin giao dịch trực tuyến của khách hàng.</p>
                                <p>Trạm Hoa yêu cầu các cá nhân khi đăng kí thành viên/ mua hàng phải cung cấp đầy đủ các
                                    thông tin cá nhân như Họ và tên, địa chỉ, số điện thoại, số tài khoản, thẻ thanh toán, …
                                    và phải chịu trách nhiệm pháp lý với những thông tin khách hàng tự cung cấp. Nếu có bất
                                    kì vấn đề xảy ra do thông tin sai chúng tôi sẽ không chịu trách nhiệm.</p>
                                <p>Ngoại trừ việc cung cấp thông tin theo yêu cầu của cơ quan Nhà nước có thẩm quyền, hoặc
                            ...
                            <div class="menu-foot-menu-container">
                                <ul id="menu-foot-menu" class="links footer-nav uppercase">
                                    ...
                                    <li id="menu-item-4085"
                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-privacy-policy current-menu-item page_item page-item-3 current_page_item menu-item-4085">
                                        <a rel="privacy-policy" href="https://tramhoa.com/chinh-sach-bao-mat/"
                                            aria-current="page">Bảo Mật</a></li>
                                ...
                                <form class="woocommerce-form woocommerce-form-login login" method="post">
                                    ...
                                    <p class="form-row">
                                        ...
                                        <input type="hidden" id="woocommerce-login-nonce" name="woocommerce-login-nonce"
                                            ...
                                            value="/chinh-sach-bao-mat/" /> <button type="submit"
                                ...
                                <form method="post" class="woocommerce-form woocommerce-form-register register">
                                    ...
                                    <p class="woocommerce-form-row form-row">
                                        <input type="hidden" id="woocommerce-register-nonce"
                                            ...
                                            name="_wp_http_referer" value="/chinh-sach-bao-mat/" /> <button
                                            type="submit"
