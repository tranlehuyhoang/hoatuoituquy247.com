<div>
    ...
    <body
        class="home page-template page-template-page-blank page-template-page-blank-php page page-id-193 theme-flatsome woocommerce-no-js full-width header-shadow lightbox nav-dropdown-has-arrow nav-dropdown-has-shadow mobile-submenu-slide mobile-submenu-slide-levels-1">
        ...
        <div id="wrapper">
            ...
            <main id="main" class="">
                <div id="content" role="main" class="content-area">
                    <div class="row row-collapse" id="row-532764254">
                        <div id="col-395606089" class="col small-12 large-12">
                            <div class="col-inner">
                                ...
                                <div id="gap-973472095" class="gap-element clearfix"
                        ...
                        <div id="col-745855868" class="col medium-3 small-6 large-3">
                            <div class="col-inner">
                                <div class="icon-box featured-box icon-box-center text-center is-small">
                                    ...
                                    <div class="icon-box-text last-reset">
                                        <div id="text-1865698645" class="text">
                                            <h3><span data-text-color="primary">Hình Hoa Thật</span></h3>
                                            <p>Gửi hoa thành phẩm trước khi giao</p>
                                            <style>
                                                #text-1865698645 {
                                                    font-size: 0.9rem;
                                                }
                        ...
                        <div id="col-630973427" class="col medium-3 small-6 large-3">
                            <div class="col-inner">
                                <div class="icon-box featured-box icon-box-center text-center is-small">
                                    <div class="icon-box-img" style="width: 40px">
                                        <div class="icon">
                                    ...
                                    <div class="icon-box-text last-reset">
                                        <div id="text-218587395" class="text">
                                            <h3 style="text-align: center;"><span data-text-color="primary">Giao Hoa
                                                    Nhanh</span></h3>
                                            <p style="text-align: center;">Giao hoa nhanh 60-120
                                                phút<strong><br /></strong></p>
                                            <style>
                                                #text-218587395 {
                                                    font-size: 0.9rem;
                                                }
                        ...
                        <div id="col-1915464068" class="col medium-3 small-6 large-3">
                            <div class="col-inner">
                                <div class="icon-box featured-box icon-box-center text-center is-small">
                                    <div class="icon-box-img" style="width: 40px">
                                        <div class="icon">
                                    ...
                                    <div class="icon-box-text last-reset">
                                        <div id="text-2629329003" class="text">
                        ...
                        <div id="col-200511422" class="col medium-3 small-6 large-3">
                            <div class="col-inner">
                                <div class="icon-box featured-box icon-box-center text-center is-small">
                                    <div class="icon-box-img" style="width: 40px">
                                        <div class="icon">
                                            <div class="icon-inner">
                                                <img loading="lazy" decoding="async" width="1" height="1"
                                                    src="/assets/wp-content/uploads/2023/08/camera.svg"
                                                    class="attachment-medium size-medium" alt="" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="icon-box-text last-reset">
                                        <div id="text-4145839624" class="text">
                                            <h3><span data-text-color="primary">Ảnh Xác Nhận</span></h3>
                    ...
                    <div id="gap-1265881488" class="gap-element clearfix" style="display:block; height:auto;">
                        <style>
                            #gap-1265881488 {
                                padding-top: 50px;
                            }
                    ...
                    <section class="section" id="section_618825417">
                        <div class="section-bg fill"></div>
                        <div class="section-content relative">
                            <div id="text-1003443384" class="text">
                                <h2 class="uppercase"><span data-text-color="success">Mẫu Hoa Mới Nhất</span></h2>
                                <style>
                                    #text-1003443384 {
                                        font-size: 1.5rem;
                                        text-align: center;
                            ...
                            <div id="gap-1836579164" class="gap-element clearfix"
                                style="display:block; height:auto;">
                                <style>
                                    #gap-1836579164 {
                                        padding-top: 20px;
                            ...
                            <div class="row large-columns-6 medium-columns-3 small-columns-2 row-small">
                                @foreach ($categories as $category)
                                    <div class="product-category col">
                                        <div class="col-inner">
                                            <a aria-label="Truy cập danh mục sản phẩm {{ $category->name }}"
                                                ...
                                                <div class="box box-category has-hover box-normal">
                                                    ...
                                                    <div class="box-text show-on-hover hover-bounce text-center"
                                                        ...
                                                        <div class="box-text-inner">
                                                            <h5 class="uppercase header-title">{{ $category->name }}
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <section class="section" id="section_1437499448">
                        <div class="section-bg fill"></div>
                        <div class="section-content relative">
                            <div class="row row-small align-middle align-center" id="row-489755699">
                    ...
                    <div class="row row-small" id="row-1356064746">
                                    ...
                                    <a class="" >
                                        <div class="img-inner box-shadow-1 dark">
                                            <img loading="lazy" decoding="async" width="640" height="210"
                                                ...
                                                class="attachment-original size-original" alt="Phương thức thanh toán"
                                    ...
                                    <a class="" >
                                        <div class="img-inner box-shadow-1 dark">
                                            <img loading="lazy" decoding="async" width="640" height="210"
                                                ...
                                                alt="Hình hoa thực tế và đánh giá từ khách hàng"
                                                sizes="auto, (max-width: 640px) 100vw, 640px" />
                                        </div>
                                    </a>
                                    <style>
                    ...
                    <section class="section" id="section_505012440">
                        <div class="section-bg fill"></div>
                        <div class="section-content relative">
                            <div class="row row-divided" id="row-964075798">
                                    ...
                                    <div class="col-inner">
                                        <div id="text-575565416" class="text homepage-about">
                                            ...
                                            <p>Việc gửi tặng hoa trở nên vô cùng đơn giản khi Hoa Tươi Tứ Quý cung cấp công cụ
                                                ...
                                                tin
                                                đơn hàng với khách hàng. Sau khi hoàn thành sản phẩm, Nhân viên giao
                                                hàng sẽ
                                            ...
                                            <p>Shop qua tươi Hoa Tươi Tứ Quý luôn sẵn sàng lắng nghe nhu cầu của khách hàng.
                                                ...
                                                trọng, bạn lỡ quên mua hoa chúc mừng mà thời gian đã gần kề, đừng lo
                                                Trạm
                                                Hoa sẽ giúp bạn giải quyết vấn đề nan giải này. Dù trong hoàn cảnh nào,
                                                <b>shop hoa tươi </b>chúng tôi luôn đảm bảo giao đúng, đủ và chất lượng.
                                            </p>
                                            <style>
                                                #text-575565416 {
                                                    font-size: 0.8rem;
                                ...
                                <div id="col-1372130609" class="col medium-6 small-12 large-6">
                                    <div class="col-inner">
                                        <div id="text-2339399617" class="text homepage-about">
                                            ...
                                            <p>Với hệ thống chi nhánh cửa hàng hoa tươi liên kết trên toàn quốc, Trạm
                                                ...
                                                nghiệp.
                                                Nếu quý khách có nhu cầu <strong>gửi tặng hoa</strong> cho người nhận,
                                                Trạm
                                                Hoa sẽ tư vấn cho khách hàng những mẫu <strong>hoa tươi</strong> phù hợp
                                                nhất cho mỗi dịp, lễ trong năm. Sản phẩm sẽ được thực hiện bởi những thợ
                                                cắm
                                                hoa lành nghề nhất tại khu vực bạn muốn giao hoa. <strong>Trạm
                                                    hoa</strong>
                                ...
                                <form class="woocommerce-form woocommerce-form-login login" method="post">
                                    ...
                                    <p class="form-row">
                                        ...
                                        <input type="hidden" id="woocommerce-login-nonce"
                                            name="woocommerce-login-nonce" value="1f444a28f5" /><input type="hidden"
                                            name="_wp_http_referer" value="/" /> <button type="submit"
                                ...
                                <form method="post" class="woocommerce-form woocommerce-form-register register">
                                    ...
                                    <p class="woocommerce-form-row form-row">
                                        <input type="hidden" id="woocommerce-register-nonce"
                                            name="woocommerce-register-nonce" value="5ca88a938b" /><input
