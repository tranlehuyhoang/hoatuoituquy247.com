<div>
    ...
    <head>
        ...
        <title>{{ $search }} - Hoa Tươi Tứ Quý</title>
                            ...
                            <div class="is-smaller">
                                <nav class="rank-math-breadcrumb breadcrumbs uppercase">
                                    <p><a href="/">Trang chủ</a><span class="separator"> &raquo;
                                        </span><span class="last">Kết quả cho {{ $search }}</span></p>
                                </nav>
                            </div>
                        </div>
                        <div class="flex-col medium-text-center">
                            <p class="woocommerce-result-count hide-for-medium" role="alert" aria-relevant="all"
                                ...
                                Hiển thị tất cả 3 kết quả<span class="screen-reader-text">Được sắp xếp theo mức độ phổ
                                    biến</span></p>
                                <select name="orderby" class="orderby" aria-label="Đơn hàng của cửa hàng" wire:model.live="orderby">
                        ...
                        <div class="col large-12">
                            <div class="shop-container">
                                ...
                                <div class="products row row-small large-columns-5 medium-columns-3 small-columns-2 has-equal-box-heights">
                                    ...
                                    <div class="product-small col has-hover product type-product post-{{ $product->id }} status-publish first instock product_cat-{{ $product->categories->pluck('slug')->join(' product_cat-') }}">
                                        <div class="col-inner">
                                            ...
                                            <div class="product-small box ">
                                                    ...
                                                    <div class="image-none">
                                                        <a href="/product/{{ $product->slug }}" aria-label="{{ $product->name }}">
                                                            <img width="360" height="450"
                                                                src="{{ Storage::url($product->images[0]) }}" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail"
                                                ...
                                                <div class="box-text box-text-products text-center grid-style-2">
                                                    ...
                                                    <div class="price-wrapper">
                                                        <span class="price"><span class="woocommerce-Price-amount amount"><bdi>{{ number_format($product->price) }} VND</bdi></span></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
