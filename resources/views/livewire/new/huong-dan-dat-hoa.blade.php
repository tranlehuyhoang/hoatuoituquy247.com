                                    ...
                                    <div class="banner-inner fill">
                                        <div class="banner-bg fill" data-parallax="-4" data-parallax-container=".banner"
                                            ...
                                            <img fetchpriority="high" decoding="async" width="1020" height="680"
                                                src="/assets/wp-content/uploads/2019/09/arts-arts-and-crafts-bloom-529927-1024x683.jpg.webp"
                                                                ...
                                                                <div class="icon">
                                                                    <div class="icon-inner">
                                                                        <img decoding="async" width="1"
                                                                            height="1"
                                                                            src="/assets/wp-content/uploads/2023/09/search.svg"
                                                            ...
                                                            <div class="icon-box-img" style="width: 60px">
                                                                <div class="icon">
                                                                    <div class="icon-inner">
                                                                        <img decoding="async" width="1"
                                                                            height="1"
                                                                            src="/assets/wp-content/uploads/2023/08/credit-card.svg"
                                                                            class="attachment-medium size-medium"
                                                                            alt="" />
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="icon">
                                                                    <div class="icon-inner">
                                                                        <img loading="lazy" decoding="async"
                                                                            width="1" height="1"
                                                                            src="/assets/wp-content/uploads/2023/09/image.svg"
                                                                            class="attachment-medium size-medium"
                                                                            alt="" />
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="icon">
                                                                <div class="icon-inner"
                                                                    ...
                                                                    <img loading="lazy" decoding="async" width="128"
                                                                        height="128"
                                                                        src="/assets/wp-content/uploads/2019/09/headphones.png.webp"
                                                                        class="attachment-medium size-medium"
                                                                        alt=""
                                                                        srcset="/assets/wp-content/uploads/2019/09/headphones.png.webp 128w, /assets/wp-content/uploads/2019/09/headphones-100x100.png.webp 100w"
                                                            ...
                                                            <div class="icon">
                                                                <div class="icon-inner"
                                                                    ...
                                                                    <img loading="lazy" decoding="async" width="64"
                                                                        height="64"
                                                                        src="/assets/wp-content/uploads/2019/09/package-1.png.webp"
                                                                        class="attachment-medium size-medium"
                                                                        alt="" />
                                                                </div>
                                                            </div>
